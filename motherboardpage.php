        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productsmotherboard ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productsmotherboard ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT ramtype FROM productsmotherboard ORDER BY ramtype";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['ramtype']; ?>" id="ramtype"><?= $row['ramtype']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose Your MotherBoard
                          </h5>
                          <hr>
                          ...
                          <div class="row" id="result">
                           <?php
                           $sql="SELECT * FROM productsmotherboard";
                           $result=$conn->query($sql);
                           while($row=$result->fetch_assoc()){
                               ?>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                var ramtype  =get_filter_text('ramtype');

                $.ajax({
                    url: 'actionmotherboard.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,ramtype:ramtype},
