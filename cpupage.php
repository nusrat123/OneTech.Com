        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productscpu ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productscpu ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <h6 class="text-info">Core</h6>
                      <ul class="list-group">
                         <?php
                             
                             $sql="SELECT DISTINCT numberofcore FROM productscpu ORDER BY numberofcore";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['numberofcore']; ?>" id="numberofcore"><?= $row['numberofcore']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose your CPU
                          </h5>
                          <hr>
                                  ...
                                  <div class="card-deck">
                                      <div class="card border-secondery">
                                         ...
                                         <div class="card-body">
                                              ...
                                              <p> 
                                              Number of Core: <?= $row['numberofcore']; ?><br>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                var numberofcore  =get_filter_text('numberofcore');

                $.ajax({
                    url: 'actioncpu.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,numberofcore:numberofcore},
