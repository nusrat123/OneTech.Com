        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productscasing ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productscasing ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <h6 class="text-info">Motherboard type</h6>
                      <ul class="list-group">
                         <?php
                             
                             $sql="SELECT DISTINCT mbtype FROM productscasing ORDER BY mbtype";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['mbtype']; ?>" id="mbtype"><?= $row['mbtype']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose your Casing</h5>
                          <hr>
                          ...
                          <div class="row" id="result">
                           <?php
                           $sql="SELECT * FROM productscasing";
                           $result=$conn->query($sql);
                           while($row=$result->fetch_assoc()){
                               ?>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                var mbtype  =get_filter_text('mbtype');

                $.ajax({
                    url: 'actioncasing.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,mbtype:mbtype},
