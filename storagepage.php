        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productsstorage ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productsstorage ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT type FROM productsstorage ORDER BY type";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose Your Storage
                          </h5>
                          <hr>
                          ...
                          <div class="row" id="result">
                           <?php
                           $sql="SELECT * FROM productsstorage";
                           $result=$conn->query($sql);
                           while($row=$result->fetch_assoc()){
                               ?>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                $.ajax({
                    url: 'actionstorage.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,type:type},
