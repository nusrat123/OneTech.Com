        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productsmonitor ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productsmonitor ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT screensize FROM productsmonitor ORDER BY screensize";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['screensize']; ?>" id="screensize"><?= $row['screensize']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                      ...
                      <h6 class="text-info">Select Resolution</h6>
                      <ul class="list-group">
                         <?php
                             
                             $sql="SELECT DISTINCT resolution FROM productsmonitor ORDER BY resolution";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['resolution']; ?>" id="resolution"><?= $row['resolution']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose your monitor
                          </h5>
                          <hr>
                          ...
                          <div class="row" id="result">
                           <?php
                           $sql="SELECT * FROM productsmonitor";
                           $result=$conn->query($sql);
                           while($row=$result->fetch_assoc()){
                               ?>
                                  ...
                                  <div class="card-deck">
                                      <div class="card border-secondery">
                                         ...
                                         <div class="card-body">
                                              ...
                                              <p> 
                                              Screen Resolution: <?= $row['resolution']; ?><br>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                var screensize  =get_filter_text('screensize');
                var resolution  =get_filter_text('resolution');

                $.ajax({
                    url: 'actionmonitor.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,screensize:screensize,resolution:resolution},
