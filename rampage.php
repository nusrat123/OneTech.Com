        ...
        <div class="small-container-3">
                   ...
                   <div class="col-lg-3">
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT pricerange FROM productsram ORDER BY pricerange";
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT brand FROM productsram ORDER BY brand";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                      ...
                      <ul class="list-group">
                         <?php
                             ...
                             $sql="SELECT DISTINCT capacity FROM productsram ORDER BY capacity";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['capacity']; ?>" id="capacity"><?= $row['capacity']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                      ...
                      <h6 class="text-info">Select Bus Speed</h6>
                      <ul class="list-group">
                         <?php
                             
                             $sql="SELECT DISTINCT busspeed FROM productsram ORDER BY busspeed";
                             $result= $conn->query($sql);
                             while($row=$result->fetch_assoc()){
                         ...
                         <li class="list-group-item">
                           <div class="form-check">
                             <label class="form-check-label">
                                  <input type="checkbox" class="form-check-input product_check"  value="<?= $row['busspeed']; ?>" id="busspeed"><?= $row['busspeed']; ?>
                             </label>
                           </div>
                         </li>
                        <?php } ?>
                    ...
                    <br>
                         ...
                         <h5 class="text-center" id="textChange"> Choose Your Ram
                          </h5>
                          <hr>
                                  ...
                                  <div class="card-deck">
                                      <div class="card border-secondery">
                                         ...
                                         <div class="card-body">
                                              ...
                                              <p> 
                                              Number of Core: <?= $row['capacity']; ?><br>
          ...
          $(document).ready(function(){
              $(".product_check").click(function(){
                ...
                var busspeed  =get_filter_text('busspeed');

                $.ajax({
                    url: 'actionram.php',
                    method:'POST',
                    data:{action:action,pricerange:pricerange,brand:brand,capacity:capacity,busspeed:busspeed},
